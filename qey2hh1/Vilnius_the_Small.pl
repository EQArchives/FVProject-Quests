...
sub EVENT_ITEM {
	...
	if(plugin::takeItems(28014 => 1)) {
		...
		#:: Give 1,500 experience
		quest::exp(1500);
		#:: Match a 5411 - Fleshripper, 5410 - Painbringer, 5401 - Mithril Two-Handed Sword, and 5308 - Gigantic Zweihander
		...
		quest::exp(3000);
		#:: Give 0 copper, 0 silver, 100 gold, and 20 platinum
		quest::givecash(0, 0, 100, 20);
	#:: Match a 1357 - Robe of the Ishva, 1253 - Robe of the Kedge, 1354 - Robe of the Oracle, 1360 - Shining Metallic Robes
		...
		#:: Give 3,000 experience
		quest::exp(3000);
		#:: Give 0 copper, 0 silver, 200 gold, and 15 platinum
		quest::givecash(0, 0, 200, 15);
	#:: Match a 7041 - Burning Rapier, 7509 - Martune Rapier, 7508 - Eyerazzia, 7020 - Well-Balanced Rapier
		...
		#:: Give a 28014 - Stanos' Pouch
		quest::summonitem(28014);
		#:: Ding!
		quest::ding();
		#:: Give 3,000 experience
		quest::exp(3000);
		#:: Give 0 copper, 0 silver, 300 gold, and 10 platinum
